...
function UpdatePlayerTable(connectedPlayers, maxplayers)
    ...
    SetDiscordAppId(1013464952914325637)
    SetDiscordRichPresenceAsset('redrp')
    SetDiscordRichPresenceAssetText('Red Roleplay')
    SetDiscordRichPresenceAssetSmall('red_discord')
    SetRichPresence(totalPlayers.."/128 players")
    SetDiscordRichPresenceAssetSmallText('discord.gg/rdrpcz')
end
